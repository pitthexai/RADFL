...
def train(args, root_model, train_dataloaders, val_dataloaders, test_dataloader, model_folder) -> None:
    ...
    for round in range(1, args.rounds + 1):
        ...
        # print("Available train_dataloaders keys:", train_dataloaders.keys())
...
def main():
    ...
    parser.add_argument("--agg_method", type=str, default="fedavg", choices=['fedavg', 'fedprox', 'feddyn', 'fedgen', 'fedsam', 'fedscaffold'], help='choose method')
    ...
    model_name = '{}_{}_rounds_{}_nclientepochs_{}_lr_{}_batchsize_{}_imgsize_{}_trial_{}'.format(args.agg_method, args.model, args.rounds, args.n_client_epochs, args.lr, args.batch_size, args.img_size, args.trial)
